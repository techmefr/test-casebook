...
4. **Typing** — strict per Pass B step 3: no `any`, no untyped fixtures/mocks, no blind `as`; type-check / lint clean. **PHP/Pest:** fixtures/factories typed against real Models/Resources/DTOs, no bare untyped arrays standing in for a domain object.
